...
public class EchoServer extends AbstractServer 
{
    ...
    (Object msg, ConnectionToClient client)
  {
	  if (((String) msg).startsWith("#login")) {
		  if (client.getInfo("loginID") != null) {
			  ...
			  System.out.println(client.getInfo("loginID") + " has connected!");
  ...
  synchronized protected void clientException(
	  ...
	  if (exception.toString().equals("java.io.EOFException")) {
			...
			System.out.println("Client " + client + " has thrown the exception " + exception);
			}
  ...
  public static void main(String[] args) 
  {
    ...
    ServerConsole sc;
	try {
		sc = new ServerConsole(port); //Automatically creates a server with the console
		sc.accept(); //listens for commands
	} catch (IOException e) {
		System.exit(0);
	}
  }
